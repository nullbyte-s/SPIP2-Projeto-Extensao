...
function fetchCityData($state, $city) {
    header('Access-Control-Allow-Origin: *');
    header('Content-Type: application/json');

    // Constrói a URL para a solicitação ao site externo
    $url = "https://pt.db-city.com/Brasil--{$state}--{$city}";

    // Faz a solicitação HTTP para o site externo
