            ...
            <div class="container-fluid px-4">
                    ...
                    <div class="col-12 col-sm-6 col-md-5 pt-1 pt-md-0">
                        <div class="card text-center border-info shadow-sm">
                            <div class="card-body">
                                ...
                                <h5 class="card-title"><i class="fas fa-regular fa-map"></i>&nbsp;<span></span></h5>
                                <p class="card-text"></b>Mapa: <b><span id="death-by-city"></span> Pacientes por Município</b></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-9">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body text-center mx-auto my-auto" style="overflow-x: auto; overflow-y: auto; max-height: 400px;">
                            <div id="sexChart"></div>
                            <div id="ageChart"></div>
                            <div id="cityChart"></div>
                            <div id="symptomsChart"></div>
                            <div id="comorbiditiesChart"></div>
                            <div id="evolutionChart"></div>
                            <div id="vaccinationChart"></div>
                            <div id="diagnosticHypothesisChart"></div>
                        </div>
                    </div>
                </div>
            </div>
